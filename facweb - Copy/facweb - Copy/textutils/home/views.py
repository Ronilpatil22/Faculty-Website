...
def index(request):
    ...
    return render(request, "index.html",{'testimonial_1': testimonial_list,'introduction':introduction_list,'newsletter':newsletter_list,'socialmedia':socialmedia_list,'navbar':Navbar_list,'Navbar_icon':Navbar_icon_list,'socialmediabarmessage':socialmediabarmessage_list})